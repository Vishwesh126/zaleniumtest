...
//	static String executionArea = "Local";
	...
	static String zaleniumTestName = "UploadTest";
	...
	public static void downloadFileForUpload() throws Exception {
		wd.get("https://chromedriver.storage.googleapis.com/index.html?path=2.9/");
		System.out.println("URL launched for downloading the file");
		try {
			wd.findElement(By.xpath("//a[text()='chromedriver_mac32.zip']")).click();
			Thread.sleep(10000);
